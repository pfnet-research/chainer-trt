...
#define CMDLINE_PARSER_PACKAGE "tensorrt_builder"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "tensorrt_builder"
#endif
...
struct gengetopt_args_info
{
  ...
  char * dir_arg;	/**< @brief path to directory name contains model json and weights exported by caffe2tensorrt.py.  */
  char * dir_orig;	/**< @brief path to directory name contains model json and weights exported by caffe2tensorrt.py original value given at command line.  */
  const char *dir_help; /**< @brief path to directory name contains model json and weights exported by caffe2tensorrt.py help description.  */
