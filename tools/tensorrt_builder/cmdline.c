...
const char *gengetopt_args_info_usage = "Usage: tensorrt_builder [OPTIONS]...";
...
const char *cmdline_parser_mode_values[] = {"fp32", "fp16", 0}; /*< Possible values for mode. */
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->max_batch_help = gengetopt_args_info_help[6] ;
  args_info->workspace_help = gengetopt_args_info_help[7] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:g:o:m:b:w:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'i':	/* path to directory name contains model json and weights exported by caffe2tensorrt.py.  */
