...
const char *gengetopt_args_info_usage = "Usage: increment_plugin [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -i, --dir=filename  path to directory exported by dump_network.py",
    0
};
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'i':	/* path to directory exported by dump_network.py.  */
